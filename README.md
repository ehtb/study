...
|----------|-------------|
| [neural_net/notebook.ipynb](neural_net/notebook.ipynb) | **Building a Neural Network from Scratch** — from derivatives to a working multi-layer perceptron with automatic differentiation, backpropagation, and training optimizations, using only pure Python |
